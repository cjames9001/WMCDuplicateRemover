...
namespace WMCDuplicateRemover.Tests
{
    public class BuildGetSeriesUrlTests : TestMetaDataWrapper
    {
        ...
        {
            yield return new TestCaseData(new MockMetaDataWrapper("The Simpsons", new DateTime(2015, 4, 26)))
            ...
            yield return new TestCaseData(new MockMetaDataWrapper("Forensic Files", new DateTime(2015, 4, 24)))
                .Returns("http://thetvdb.com/api/GetSeries.php?seriesname=forensic files")
                .SetDescription("Check that series name has a value")
                .SetName("TestBuildForensicFilesUrl");

            yield return new TestCaseData(new MockMetaDataWrapper("Last Week Tonight", new DateTime(2015, 8, 26)))
                .Returns("http://thetvdb.com/api/GetSeries.php?seriesname=last week tonight")
                .SetDescription("Check that series name has a value")
                .SetName("TestBuildLastWeekTonightUrl");

            yield return new TestCaseData(new MockMetaDataWrapper("NHL Hockey", new DateTime(2015, 9, 26)))
